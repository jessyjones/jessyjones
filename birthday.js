var myObj = [{nom: "Fanny", moisAnniversaire: 09, jourAnniversaire:18},
             {nom: "Manon", moisAnniversaire: 12, jourAnniversaire:11},
...
let counter = 0;
 ...
 if (days_Diff < 15 && days_Diff !== 0){
   document.getElementById("birthdaypredictor").innerHTML+= "Ce sera l’anniversaire de " + myObj[i].nom + " le " + myObj[i].jourAnniversaire+"<br>";
